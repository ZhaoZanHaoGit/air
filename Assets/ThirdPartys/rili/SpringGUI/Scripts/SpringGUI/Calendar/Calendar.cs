...
namespace SpringGUI
{
    ...
    public class Calendar : UIBehaviour
    {
        ...
        private TMP_Text _timeButtonText = null;
        ...
        protected override void Awake()
        {
            ...
            _timeButtonText = m_Transform.Find("Title/TimeButton/Text").GetComponent<TMP_Text>();
        ...
        private void WeekGenerator( GameObject weekPrefab ,Transform parent )
        {
            for (int i = 0; i < 7; i++)
            {
                ...
                week.GetComponent<TMP_Text>().text = getWeekName(i.ToString());
            }
            Destroy(weekPrefab);
        }
