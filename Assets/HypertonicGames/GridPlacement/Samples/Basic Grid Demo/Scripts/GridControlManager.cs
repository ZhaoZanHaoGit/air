...
namespace Hypertonic.GridPlacement.Example.BasicDemo
{
    ...
    public class GridControlManager : MonoBehaviour
    {
        ...
        private void HandleConfirmButtonPressed()
        {
            ...
            if (placed)
            {
                OnObjectPlacedOnGrid?.Invoke(GridManagerAccessor.GridManager.ObjectToPlace);
        ...
        public void ReturnItemUI(GameObject @object)
        {
            ...
            if (gameObject.TryGetComponent(out Item3D Object))
            {
                Object.itemUI.itemnum++;
                Object.itemUI.chazhi--;
                Object.itemUI.UpdateUIState();
                ItemManager.Instance.AddItem(Object.itemSelf, 1);
            }
